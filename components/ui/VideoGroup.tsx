    ...
    return (
        <div>
            ...
            <div className="container opacity-0 hover:opacity-100 absolute right-0 top-0 h-[200px] w-fit m-1 hover:m-6 hover:h-[250px] hover:translate-x-5 transistion duration-1000">
                <Video src="/Videos/rishabh-abhishek-dance.mp4" />
            </div>
            ...
            {/* sides  */}
            <div className="container opacity-0 hover:opacity-100 absolute right-[0vw] top-[40vh] h-[100px] w-fit m-1 hover:m-6 hover:h-[200px] hover:translate-x-5 transistion duration-1000">
                <Video src="/Videos/Proof.mp4" />
            </div>
            <div className="container opacity-0 hover:opacity-100 absolute left-[0vw] bottom-[40vh] h-[100px] w-fit m-1 hover:m-6 hover:h-[200px]   hover:translate-x-5 transistion duration-1000">
                <Video src="/Videos/rishabh-abhishek-dance.mp4" />
            </div>
